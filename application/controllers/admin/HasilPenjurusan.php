...
class HasilPenjurusan extends Super
{
    ...
    function __construct()
    {
        ...
        $this->active_id_menu = "Hasil";
        $this->nama_view      = "Hasil";
        $this->status         = true; 
    ...
    function index(){
            ...
            **/
            $this->crud->set_relation('id_siswa','nilai_siswa','nama_siswa');
            ...
            $this->crud->display_as('id_siswa','Nama Siswa'); 
